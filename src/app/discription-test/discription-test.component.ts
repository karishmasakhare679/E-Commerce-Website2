...
@Component({
  selector: 'app-discription-test',
  templateUrl: './discription-test.component.html',
  styleUrls: ['./discription-test.component.css']
})
export class DiscriptionTestComponent implements OnInit {

  something: any= localStorage.getItem('image');
  ...
  increase(quantity: any) {
    if (quantity >= 0) {
      let inc = this.dataSource[0].quantity + 1
      this.dataSource[0].quantity = inc
